...
class DatabaseConn {
  ...
  public function select() {
		...
		return new jsc_select($this->DatabaseConn);
	}
	// public function insert() {
	// 	include_once 'function_insert.php';
	// 	return new function_insert($this->DatabaseConn);
	// }
	// public function delete() {
	// 	include_once 'function_delete.php';
	// 	return new function_delete($this->DatabaseConn);
	// }
 //  public function update(){
 //    include_once 'function_update.php';
 //    return new function_update($this->DatabaseConn);
  // }
}
 ?>
